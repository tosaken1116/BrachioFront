...
import type { EnergyType, MasterCardType } from "@/domains/card/types";
  ...
  return (
    <div className="relative w-fit">
      ...
      <svg width="150" height="200" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <polygon points="110,200 130,175 130,115 110,140" fill="#898989" />
        <polygon points="20,190 110,200 110,140 20,130" fill="#d9d9d9" />
        <polygon points="20,130 110,140 110,130 20,120" fill={"#626262"} />
        <polygon points="110,140 130,120 130,115 110,135" fill={"#434343"} />
