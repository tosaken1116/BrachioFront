...
export const GoodsCard: FC<Props> = ({ card }) => {
  ...
  return (
    <CardBase card={card}>
      <div className="flex flex-col h-full bg-gradient-to-r from-blue-200 rounded-sm via-white  to-blue-200">
        <div className="flex flex-row italic justify-between rounded-md bg-gradient-to-r from-blue-300 via-20% via-slate-200 to-slate-200 drop-shadow-sm py-0.5 px-2 border border-slate-300">
          <strong className="text-xs">グッズ</strong>
        ...
        <div className="flex flex-row  h-12 items-center relative">
          ...
          <div className="absolute right-0 rounded-md h-8 -top-2 items-center flex bg-gradient-to-r from-blue-400 shadow-inner border  border-r-0 rounded-br-none rounded-tr-none w-3/4 border-slate-300  via-slate-200 to-blue-400 drop-shadow-sm py-0.5 px-2 text-[8px]">
